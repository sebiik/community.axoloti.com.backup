<patch-1.0 appVersion="1.0.12">
   ...
   <obj type="script/script2" uuid="d39e743cf47c9221f4e99c133430148cf74c68c5" name="script2_1" x="406" y="42">
      <params/>
      <attribs>
...
const SPIConfig spicfg_a = {NULL, GPIOA, 4, 3<<3 | SPI_CR1_LSBFIRST}; //MCP3008 takes LSB first, uses extra CS pin
const SPIConfig spicfg_b = {NULL, GPIOB, 0, 3<<3 | SPI_CR1_LSBFIRST}; //MCP3008 takes LSB first, uses extra CS pin
const SPIConfig spicfg_c = {NULL, GPIOB, 1, 3<<3 | SPI_CR1_LSBFIRST}; //MCP3008 takes LSB first, uses extra CS pin
...
//	led3 = false;
	...
	palSetPadMode(GPIOC,0,PAL_MODE_INPUT_PULLDOWN);	// BUTTON 4
	palSetPadMode(GPIOC,1,PAL_MODE_INPUT_PULLDOWN);	// BUTTON 1
	palSetPadMode(GPIOC,2,PAL_MODE_INPUT_PULLDOWN);	// BUTTON 2
	palSetPadMode(GPIOC,3,PAL_MODE_INPUT_PULLDOWN);	// BUTTON 3
  	

//  	palSetPadMode(GPIOA,4,PAL_MODE_OUTPUT_PUSHPULL);	// MCP23s17
	palSetPadMode(GPIOA,4,PAL_MODE_OUTPUT_PUSHPULL);	// MCP3208 1
  	palSetPadMode(GPIOB,0,PAL_MODE_OUTPUT_PUSHPULL);	// MCP3208 2
 	palSetPadMode(GPIOB,1,PAL_MODE_OUTPUT_PUSHPULL);	// MCP3208 3
//	palWritePad(GPIOA,4,1);					// pull high to disable MCP23s17
	palWritePad(GPIOA,4,1);					// pull high to disable first MCP32088
	palWritePad(GPIOB,0,1);					// pull high to disable second MCP3208
	palWritePad(GPIOB,1,1);					// pull high to disable third MCP3208

//	palWritePad(GPIOA,4,0);					// pull high to disable MCP23s17
...
void loop(void){
	...
	palWritePad(GPIOB,0,1);		// disable MCP3208
	palWritePad(GPIOB,1,1);		// disable MCP3208


	read_buttons();
	update_display();
	read_adc(&spicfg_a, knob_bank_a);
   ...
   <obj type="gpio/i2c/config" uuid="b095a33e56de5fcd23740a7d983bc0bafb315d81" name="config_2" x="574" y="70">
      <params/>
      <attribs/>
   </obj>
   ...
   <obj type="tiar/HW/OLED128x64niceWOScope" uuid="5bde8c3d-fe37-4133-138e-edb113767bc8" name="OLED128x64niceWOScope_1" x="798" y="154">
      <params/>
      <attribs>
   ...
   <obj type="patch/inlet i" uuid="f11927f00c59219df0c50f73056aa19f125540b7" name="display_val" x="420" y="168">
      <params/>
      <attribs/>
   </obj>
   ...
   <obj type="gpio/in/digital" uuid="f59f139e8da912742832dc541157f20f30b7ac1b" name="digital_6" x="280" y="224">
      <params/>
      <attribs>
   ...
   <obj type="patch/inlet i" uuid="f11927f00c59219df0c50f73056aa19f125540b7" name="osc_nr" x="420" y="224">
      <params/>
      <attribs/>
   </obj>
   <patchobj type="patch/object" uuid="ec39e1d2-1740-4c07-8eb8-382ff025a3b5" name="choose_2" x="840" y="294">
      <params/>
      <attribs>
         <spinner attributeName="maxLength" value="11"/>
         <table attributeName="str0" table="no Filter"/>
         <table attributeName="str1" table="lowpass"/>
         <table attributeName="str2" table="highpass"/>
         <table attributeName="str3" table="bandpass"/>
         <table attributeName="str4" table="vowel"/>
      </attribs>
      <object id="patch/object" uuid="ec39e1d2-1740-4c07-8eb8-382ff025a3b5">
...
strcpy(&c4[0],"attr_str4");]]></code.init>
  ...
  case 4:
   ...
   <obj type="patch/inlet i" uuid="f11927f00c59219df0c50f73056aa19f125540b7" name="Fmode" x="728" y="308">
      <params/>
      <attribs/>
   </obj>
   ...
   <obj type="rbrt/string/choose 4" uuid="0090182e-aace-47a3-beb7-b7f1795839f2" name="choose_1" x="826" y="518">
      <params/>
      <attribs>
         <spinner attributeName="maxLength" value="11"/>
         <table attributeName="str0" table="no FX"/>
         <table attributeName="str1" table="delay"/>
         <table attributeName="str2" table="chorus"/>
         <table attributeName="str3" table=""/>
      </attribs>
   </obj>
   <obj type="patch/inlet i" uuid="f11927f00c59219df0c50f73056aa19f125540b7" name="FXSel" x="728" y="546">
      <params/>
      <attribs/>
   </obj>
   ...
   <obj type="patch/inlet i" uuid="f11927f00c59219df0c50f73056aa19f125540b7" name="LFODest" x="728" y="700">
      <params/>
      <attribs/>
   </obj>
   <obj type="rbrt/string/choose 4" uuid="0090182e-aace-47a3-beb7-b7f1795839f2" name="choose_3" x="826" y="700">
      <params/>
      <attribs>
         <spinner attributeName="maxLength" value="11"/>
         <table attributeName="str0" table="filter"/>
         <table attributeName="str1" table="oscblend"/>
         <table attributeName="str2" table="morph 1"/>
         <table attributeName="str3" table="morph 2"/>
      </attribs>
   </obj>
   ...
   <obj type="patch/inlet f" uuid="5c585d2dcd9c05631e345ac09626a22a639d7c13" name="led3" x="28" y="910">
      <params/>
      <attribs/>
   </obj>
   <obj type="gpio/out/pwm t5" uuid="73c0c557-0e70-401a-8c07-460c0010710b" name="pwm_1" x="168" y="924">
      <params/>
      <attribs/>
   </obj>
   <comment type="patch/comment" x="322" y="924" text="PWM control for LED 3"/>
   <obj type="patch/inlet f" uuid="5c585d2dcd9c05631e345ac09626a22a639d7c13" name="led4" x="28" y="952">
      <params/>
      <attribs/>
   </obj>
   <comment type="patch/comment" x="784" y="952" text="FIX AXO SHORT THEN TRY FLOAT CTRLS INSTEAD"/>
   <obj type="patch/inlet f" uuid="5c585d2dcd9c05631e345ac09626a22a639d7c13" name="led5" x="28" y="994">
      <params/>
      <attribs/>
   </obj>
   <comment type="patch/comment" x="28" y="1050" text="Button outs"/>
   <obj type="patch/outlet b" uuid="191792f616d4835dba0b55375474a12942e5bcbd" name="button_1" x="28" y="1064">
      <params/>
      <attribs/>
   </obj>
   <obj type="patch/outlet b" uuid="191792f616d4835dba0b55375474a12942e5bcbd" name="button_2" x="126" y="1064">
      <params/>
      <attribs/>
   </obj>
   <obj type="patch/outlet b" uuid="191792f616d4835dba0b55375474a12942e5bcbd" name="button_3" x="224" y="1064">
      <params/>
      <attribs/>
   </obj>
   <obj type="patch/outlet b" uuid="191792f616d4835dba0b55375474a12942e5bcbd" name="button_4" x="322" y="1064">
      <params/>
      <attribs/>
   </obj>
   <obj type="ctrl/toggle" uuid="42b8134fa729d54bfc8d62d6ef3fa99498c1de99" name="b1" x="28" y="1106">
      <params>
         <bool32.tgl name="b" value="0"/>
      </params>
      <attribs/>
   </obj>
   <obj type="ctrl/toggle" uuid="42b8134fa729d54bfc8d62d6ef3fa99498c1de99" name="b2" x="126" y="1106">
      <params>
         <bool32.tgl name="b" value="0"/>
      </params>
      <attribs/>
   </obj>
   <obj type="ctrl/toggle" uuid="42b8134fa729d54bfc8d62d6ef3fa99498c1de99" name="b3" x="224" y="1106">
      <params>
         <bool32.tgl name="b" value="0"/>
      </params>
      <attribs/>
   </obj>
   <obj type="ctrl/toggle" uuid="42b8134fa729d54bfc8d62d6ef3fa99498c1de99" name="b4" x="322" y="1106">
      <params>
         <bool32.tgl name="b" value="0"/>
      </params>
      <attribs/>
   ...
   <nets>
      ...
      <net>
         <source obj="Fmode" outlet="inlet"/>
         <dest obj="choose_2" inlet="sel"/>
      </net>
      <net>
         <source obj="choose_3" outlet="out"/>
         <dest obj="OLED128x64niceWOScope_1" inlet="line3"/>
      </net>
      <net>
         <source obj="LFODest" outlet="inlet"/>
         <dest obj="choose_3" inlet="sel"/>
      </net>
      <net>
         <source obj="b4" outlet="o"/>
         <dest obj="button_4" inlet="outlet"/>
      </net>
      <net>
      ...
      <net>
         <source obj="led4" outlet="inlet"/>
         <dest obj="pwm_1" inlet="pa1"/>
      </net>
      <net>
         <source obj="led5" outlet="inlet"/>
         <dest obj="pwm_1" inlet="pa2"/>
      </net>
      <net>
         <source obj="osc_nr" outlet="inlet"/>
