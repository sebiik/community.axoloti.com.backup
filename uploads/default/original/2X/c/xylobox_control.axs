...
void loop(void){
   ...
   <obj type="tiar/HW/OLED128x64niceWOScope" uuid="5bde8c3d-fe37-4133-138e-edb113767bc8" name="OLED128x64niceWOScope_1" x="798" y="168">
      <params/>
      <attribs>
   ...
   <obj type="rbrt/string/choose 4" uuid="0090182e-aace-47a3-beb7-b7f1795839f2" name="choose_2" x="826" y="308">
      <params/>
      <attribs>
         <spinner attributeName="maxLength" value="11"/>
         <table attributeName="str0" table="lowpass"/>
         <table attributeName="str1" table="highpass"/>
         <table attributeName="str2" table="bandpass"/>
         <table attributeName="str3" table="vowel"/>
      </attribs>
   </obj>
   ...
   <obj type="rbrt/string/choose 4" uuid="0090182e-aace-47a3-beb7-b7f1795839f2" name="choose_3" x="826" y="686">
      <params/>
      <attribs>
         <spinner attributeName="maxLength" value="11"/>
